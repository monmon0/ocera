      ...
      {user ? (
        <div className="text-center space-y-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-1">
              ...
              <p><span className="font-medium">Provider:</span> {user.app_metadata?.provider || 'google'}</p>
        ...
        <div className="text-center space-y-4">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-3 px-4 rounded-lg border border-gray-300 transition-colors duration-200 flex items-center justify-center space-x-2"
          >
