...
import { Edit, Heart, Eye, Trash2, MoreVertical, AlertTriangle, Plus, Bookmark } from "lucide-react"
...
export default function CharacterCard({ characters, onDelete, isEdit }: Props) {
